...
<!-- for bootstrap working -->
		<script src="<?php echo base_url('assets/frontend_assets/js/bootstrap.js');?>"></script>
<!-- //for bootstrap working -->
<script type='text/javascript' src="<?php echo base_url('assets/frontend_assets/js/jquery.mycart.js');?>"></script>
  <script type="text/javascript">
  $(function () {

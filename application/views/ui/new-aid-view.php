                    ...
                    <div class="card-body">
                        ...
                        <form accept-charset="UTF-8" id="newAd">
                          ...
                          <fieldset>
                            ...
                            <div class="row sms-ver-con">
                                <div class="col-12">
                                    <p class="sms-info">Enter and verify your phone number. Note: <small class="text-default sms_error">This number will be displayed on all the adverts you listed on this platform</small> </p>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">

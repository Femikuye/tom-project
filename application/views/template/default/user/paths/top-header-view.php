                ...
                <div class="frame_wrap clearfix ">
                    <div class="col-md-4">
                        <a class="ml-lg-5" href="<?php echo base_url(); ?>">
                            <img src="<?php echo $logo ?>" alt="<?php echo $site['logo'] ?> - Logo" style="width:161px;height:41px" class="mt-3">
                        </a>
                    </div>
                    <div class="col-md-7 col-sm-12 pull-right np  ml-5">
                        <h2 class="visible-lg visible-md visible-sm">
                            Buy or sell anything, anytime ,anywhere in Ghana
                        </h2>
                        <form method="get" action="<?php echo base_url('advert/searches') ?>" data-type="SearchForm" autocomplete="off">
                            <fieldset>
                                <div class="input-group col-md-7 col-sm-7 pull-left" role="search">
                                    <div class="has-sug clearfix">
                                        <input class="form-control srch_input" placeholder="I'm looking for..." type="search" name="search_data" value="<?php echo null !== $this->input->get('search_data') ? $this->input->get('search_data') : ''?>" Title="Tormami"/>
                                        <input type="hidden" class="cat-shor-name" name="cat-name" value="<?php echo null !== $this->input->get('cat-name') ? $this->input->get('cat-name') : ''?>">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn dropdown-toggle group_btn col-md-12 pull-left slct eclps" data-action="SH" data-id="SearchSelectionHolder" data-dest="[data-type=Cats]" type="button" name="Categories"><?php echo null !== $this->input->get('cat-name') ? $this->input->get('cat-name') : 'All Categories'?></button>
                                        <ul class="dropdown-menu group_dropdown" data-type="Cats">
                                            <li class="select">
                                                <a data-name="All-Categories" class="cat-pick" href="javascript:;">All Categories</a>
                                            </li>
                                                    ...
                                                    if($subs = $this->general_model->get_table_rows_by_a_field('aid_categories','parent_id',$cat['id_cat'])){
                                                        ...
                                                        foreach($subs as $sub){
                                                            ...
                                                            <ul class="list" data-item="SearchCategory" style="display: none;" data-type="<?php echo $cat['cat_name']; ?>">
                                                                <li>
                                                                    <a data-name="<?php echo $sub['cat_name'] ?>" class="cat-pick" href="javascript:">
                                ...
                                <div class="input-group col-md-4 col-sm-4 col-xs-11 pull-left" role="city">
                                    <input class="form-control region srch_input" placeholder="Ghana" type="text" name="SearchCity" value="<?php echo null !== $this->input->get('SearchCity') ? $this->input->get('SearchCity') : '' ?>" Title="SearchCity"/>								<span class="input-group-addon dg" id="basic-addon1"><i class="fa fa-map-marker"></i></span>
                                </div>
                                ...
                                <div class="region_main" data-type="Loc" style="display: none;">
                                    ...
                                    <header class="region_head voffset3 vonset3 col-md-12">
                                        <div class="input-group col-md-5 col-sm-4 col-xs-11 pull-left" role="city">
                                            <div class="has-sug clearfix">
                                                <input class="form-control srch_input region" placeholder="Ghana" type="text" name="CitySugs" value="" Title="CitySugs"/>		<div class="input_sug" style="display:none;">
                                    ...
                                    <div class="col-md-12 gray region_top">
                                        ...
                                        <div class="row">
                                            <ul class="list-unstyled col-md-12">
                                                <li>
                                                    <a class="region-pick" data-region="All-Ghana" href="javascript:">
                                                        <b>All Ghana</b>
                                                    </a>
                                                </li>
                                            </ul>
                                                    ...
                                                    if ($top_cities) {
                                                        foreach ($top_cities as $city) {
                                                            ...
                                                            <ul class="list-unstyled col-xs-6 col-sm-2 col-md-2">
                                                                <li>
                                                                    <a class="region-pick" data-region="<?php echo $city['p_name']; ?>" rel="nofollow"
                                                                       href=javascript:">

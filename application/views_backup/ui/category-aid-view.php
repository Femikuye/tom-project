...
<section class="search-sec">
    ...
    <div class="container mt--7">
        ...
        <form method="get" action="<?php echo base_url(uri_string())?>" class="">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-2 col-md-2 col-sm-12 p-0">
                            ...
                            <input name="keyword" type="text" class="form-control search-slt" placeholder="Key Word">

                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-12 p-0">

                            <input onclick="province_modal()" name="province" type="text" class="form-control search-slt p-name-holder" placeholder="City or State" readonly="true">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            ...
                            <input onclick="category_modal()" type="text" placeholder="Select Category" class="form-control search-slt category-holder" readonly="true">

                            <input type="hidden" id="cat-id-holder" name="category">

                        </div>

                        <div class="col-lg-1 col-md-1 col-sm-12 p-0">

                            <input type="price" name="price-start" class="form-control search-slt" placeholder="From ($)">

                        </div>

                        <div class="col-lg-1 col-md-1 col-sm-12 p-0">

                            <input type="price" name="price-end" class="form-control search-slt" placeholder="To ($)">

                        </div>

                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">

                            <button type="submit" id="submit" class="btn btn-danger wrn-btn">Search</button>
                        ...
                        <div class="media row">
                            ...
                            <div  class="media-body fnt-smaller col-sm-12 col-md-8 col-xs-12">
                                ...
                                <h2 class="media-heading">
                                  ...
                                  <a href="<?php echo base_url('ad/'.$this->gm->define_aid_slug($row['id_aid'],$row['aid_title'])) ?>" target="_parent"> <small class="pull-right"><?php echo substr($row['aid_title'], 0,30) ?></small></a></h2>
                                  <p class="hidden-xs"><?php echo substr($row['aid_des'], 0,40)."..." ?></p>
                                  <span class="fnt-smaller fnt-lighter fnt-arial"><?php echo $row['aid_city'].' , '.$row['aid_state'] ?> <span class="text-info" style="list-style: none"> | </span> <?php echo $this->general_model->get_a_table_row('aid_categories','id_cat',$row['aid_category_id'])['cat_name'] ?></span>
                                  <ul class="list-inline mrg-0 btm-mrg-10 clr-535353">
                                    <li><?php echo @date("D, d M Y. ",$row['date_created'])  ?></li>
                                </ul>
                                <span style="font-size: 25px; font-weight: 700;" class="fnt-smaller fnt-lighter fnt-arial"><?php echo $this->gm->define_price($row['aid_price']) ?></span>
